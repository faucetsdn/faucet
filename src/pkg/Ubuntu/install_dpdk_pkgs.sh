...
echo "OVS and DPDK related packages installation ... for Ubuntu 16.10"
apt-get install make gcc dpdk dpdk-dev dpdk-doc dpdk-igb-uio-dkms openvswitch-common openvswitch-switch openvswitch-switch-dpdk python-openvswitch openvswitch-pki openvswitch-test openvswitch-testcontroller
