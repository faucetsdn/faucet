...
python3 -m pytest ./test_check_config.py ./test_config.py ./test_fctl.py ./test_gauge.py ./test_valve.py --cov faucet --doctest-modules -v --cov-report term-missing || exit 1
